...
from navcon_client.msg import NavClient
import json
...
class NavConRequest:
    def __init__(self):
        ...
        self.full_message_pub = rospy.Publisher('lang/full', NavClient, latch=True, queue_size=10 )
    ...
    def create_request_data(self):
        ...
        #Encode images
        # en_image_front = cv2.imencode('.jpg', cv_image_front)[1].tobytes()
        # en_image_left = cv2.imencode('.jpg', cv_image_left)[1].tobytes()
        # en_image_right = cv2.imencode('.jpg', cv_image_right)[1].tobytes()
    ...
    def parse_result(self, response):
        ...
        if json_response['function'] == 'navigate_to_object':
            ...
            # TODO update these offsets to be based on the camera size
            lower = 608 - bounds[1]
    ...
    def publish_full_message(self, x, y, left, lower, right, upper):
        ...
        msg.concat_image = self.concat_image
        msg.x = x
        msg.y = y
        msg.left = left
        msg.lower = lower
