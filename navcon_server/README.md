# NavCon Server
This code is based on ViperGPT and their README is included below. Please follow the build instructions there and we would like to thank the authors for their great work. 
